...
public class Assignment_SmoothCamera : MonoBehaviour
{
    ...
    private void LateUpdate()
    {
        ...
        currentZoomDistance = Mathf.SmoothDamp(currentZoomDistance, 
            targetZoomDistance,ref zoomVelocity, zoomSmoothTime);

        Vector3 targetPos = target.position + offset.normalized * currentZoomDistance;
        ...
        transform.rotation = Quaternion.Slerp(target.rotation, look, rotationSmoothSpeed * Time.deltaTime);
